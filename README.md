...
# アプリケーション概要
  ...
  - 家にあるもの（在庫）を登録しておくことで、数回クリックするだけでお買い物リストを作ることができます。
...
[![Image from Gyazo](https://i.gyazo.com/fbff0f50fe9ed70eca5b989eb91a7cd9.gif)](https://gyazo.com/fbff0f50fe9ed70eca5b989eb91a7cd9)
...
### お買い物リスト登録
  ...
  [![Image from Gyazo](https://i.gyazo.com/acaf4bc4bed7a1b2030ea611c9ac285c.gif)](https://gyazo.com/acaf4bc4bed7a1b2030ea611c9ac285c)
...
- 買い物中は、買った商品にチェックを入れていくことができます。買い物が終わったら、買い物完了ボタンを押すと一括削除できます。
[![Image from Gyazo](https://i.gyazo.com/aa2d398953fc4c01138b99e965a898e6.gif)](https://gyazo.com/aa2d398953fc4c01138b99e965a898e6)
...
## 感じている課題
  1. 買い物リストの入力が面倒
  2. 買い物中によくある悩み①
  - 似たような商品パッケージがある、デザインが変わったなどで、いつも買っているものがどれか迷う
  - 似たような理由で、買い物を頼まれた家族が、いつも買っているものがどれかが分からない
  3. 買い物中によくある悩み②
  - いざ買い物に来た時に、「これ家にあったっけ？」となる
  4. 物価高なので、単価が一番安いものを買いたい。スマホの電卓では、計算結果を覚えておかないといけない

## 考えた解決策（それぞれ1~4の課題に対応）
  1. より少ない手間でお買い物リストを作成できるようにすること。具体的には3の通り。
  2. お買い物リストを写真で作成できるようにすること。また、それを共有できるようにグループ機能を実装すること。
  3. 家にあるものを在庫として登録できる機能を実装すること。そして、在庫一覧から数回クリックするだけでお買い物リストが作成できるようにすること。
...
# 今後の課題・実装予定の機能
  ...
  - お買い物リスト一覧表示の改善（現状、在庫から登録したもの→在庫外から登録したものの順になってしまっている）
